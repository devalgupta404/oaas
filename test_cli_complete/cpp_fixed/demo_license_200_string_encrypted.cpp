...
public:
    ...
    virtual void display_info() const {
        ...
        std::cout << "Status: " << (activated ? _xor_decrypt((const unsigned char[]){0xd7,0xf5,0xe2,0xff,0xe0,0xf3}, 6, 0x96) : _xor_decrypt((const unsigned char[]){0xf5,0xd2,0xdd,0xdf,0xc8,0xd5,0xca,0xd9}, 8, 0xbc)) << "\n";
    }
...
int main(int argc, char** argv) {
    ...
    if (valid && enterprise->is_activated()) {
        ...
        std::cout << "[CRYPTO] Signature valid: " << (sig_valid ? _xor_decrypt((const unsigned char[]){0x72,0x4e,0x58}, 3, 0x2b) : "No") << "\n";
